  ...
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
              ...
              @endif
                <div class="form">      
                  <form method="post" action="{{url('/admin/store_update_service_data')}}/{{$id}}" enctype="multipart/form-data">  
                  	...
                  	@csrf
                          ...
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <input type="text" placeholder="icon" name="icon" id="summernote" value="{{$icon}}">
