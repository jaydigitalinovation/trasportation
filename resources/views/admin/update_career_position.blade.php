...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/summernote/0.8.12/summernote-lite.css">
  ...
  <div class="page my-4 title1">
        <div class="mt-5">
            ...
            <div class="detail">
                <div class="form">      
                  <form method="post" action="{{url('/admin/store_update_career_position_data')}}/{{$id}}" enctype="multipart/form-data">  
                  	...
                  	@csrf
                          ...
                          <div class="part">
                              ...
                              <div class="col-md-12 data">
                                  <textarea type="text" name="answer" id="summernote">{{$answer}}</textarea>
