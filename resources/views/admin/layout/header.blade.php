         ...
         <ul class="menu main_drop">
            ...
            <li><a href="#"><i class="fas fa-home"></i> <span>Home</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  ...
                  <li><a href="{{url('/admin/testing')}}">Testing</a></li>
            ...
            <li><a href="#"><i class="fas fa-chart-pie"></i> <span>About Us</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  <li><a href="{{url('/admin/about_mission')}}">About_mission</a></li>
                  <li><a href="{{url('/admin/about_choose')}}">About Choose</a></li>
                  <li><a href="{{url('/admin/about_faq')}}">About FAQ</a></li>
            ...
            <li><a href="#"><i class="fas fa-chart-pie"></i> <span>Service</span> <i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  <li><a href="{{url('/admin/service_tab')}}">Service_tab</a></li>
            ...
            <li><a href="#"><i class="fas fa-image"></i><span>Career</span><i class="fal fa-chevron-down"></i></a>
               <ul class="drp-menu">
                  <li><a href="{{url('/admin/career_position')}}">Carrer_position</a></li>
                  <li><a href="#">Gallery 02</a></li>
                  <li><a href="#">Gallery 03</a></li>
               </ul>
            </li>
                     ...
                     <div id="mySidepanel" class="sidepanel">
                        <div class="m_menu main-menu">
                           ...
                           <ul class="menu main_drop">
                              ...
                              <li><a href="#"><span>Career</span> <i class="fal fa-chevron-down"></i></a>
                                 <ul class="drp-menu">
                                    <li><a href="{{url('/admin/career_position')}}">Carrer_position/a></li>
                                    <li><a href="#">Gallery 02</a></li>
                                    <li><a href="#">Gallery 03</a></li>
