 ...
 <div class="head-banner">
      ...
      <div class="page mt-4 hosting-page title1 page-with" style="display: block;">
         ...
         <div class="detail table-responsive">
           ...
           <form  action="{{url('admin/store_add_about_choose_data')}}/{{$id}}" enctype="multipart/form-data" method="POST" >
                @csrf
                ...
                <div class="details_inner">
                  <div class="part-1">
                     ...
                     <div class="details_sub">
                        <input type="file" name="image" value="{{$image}}" onchange="readURL(this);" >
